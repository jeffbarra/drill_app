...
class SearchExerciseBottomSheet extends StatefulWidget {
  final String workoutId;

  const SearchExerciseBottomSheet({Key? key, required this.workoutId})
      : super(key: key);

  @override
  State<SearchExerciseBottomSheet> createState() =>
      _SearchExerciseBottomSheetState();
}

class _SearchExerciseBottomSheetState extends State<SearchExerciseBottomSheet> {
