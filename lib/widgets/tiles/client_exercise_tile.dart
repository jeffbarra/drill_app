...
class ClientExerciseTile extends StatefulWidget {
  ...
  @override
  State<ClientExerciseTile> createState() => _ClientExerciseTileState();
}

class _ClientExerciseTileState extends State<ClientExerciseTile> {
  ...
  void _editClientExerciseNameDialog() {
