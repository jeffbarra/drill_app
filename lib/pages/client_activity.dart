...
class ClientActivityDataPage extends StatefulWidget {
  ...
  @override
  _ClientActivityDataPageState createState() => _ClientActivityDataPageState();
}

class _ClientActivityDataPageState extends State<ClientActivityDataPage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text(
            '${widget.clientName}\'s Exercise Data',
