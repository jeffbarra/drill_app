import 'package:drill_app/widgets/search_client_exercise_modal.dart';
...
class ChooseClientPastWorkoutPage extends StatefulWidget {
  final String workoutId;
  final String clientName;
  final String clientEmail;

  const ChooseClientPastWorkoutPage({
    Key? key,
  ...
  @override
  State<ChooseClientPastWorkoutPage> createState() =>
      _ChooseClientPastWorkoutPageState();
}

class _ChooseClientPastWorkoutPageState
    extends State<ChooseClientPastWorkoutPage> {
            ...
            showModalBottomSheet(
              ...
              builder: (BuildContext context) {
                return FractionallySizedBox(
                  heightFactor: 0.9,
                  child: SearchClientPastExerciseBottomSheet(
